...
public class InMemoryProductRepository implements ProductRepository {
    ...
    static {
        ...
        Product clip1 = new Clip("4", "Wsciekłe pięści węża", 2l * 1000 * 60 * 2, Money.valueOf(5));
        Product clip2 = new Clip("5", "Sum tak zwany olimpijczyk", 2l * 1000 * 60 * 2, Money.valueOf(10));
